...
class UploadersControllerTest < ActionController::TestCase
  ...
  test "should create uploader" do
    assert_difference('Uploader.count') do
      post :create, uploader: { filename: @uploader.filename, filepath: @uploader.filepath, user_id: @uploader.user_id }
    end
  ...
  test "should update uploader" do
    patch :update, id: @uploader, uploader: { filename: @uploader.filename, filepath: @uploader.filepath, user_id: @uploader.user_id }
    assert_redirected_to uploader_path(assigns(:uploader))
  end
